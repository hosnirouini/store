...
<head>
    ...
    <title>Pebona - eCommerce HTML5 Bootstrap 5 Template</title>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 order-1 col-sm-12 order-sm-1 col-md-4 order-md-2 col-lg-6">
                            <div class="logo">
                                <a href="../main/index.html.twig"><img src="assets/images/logo.png" alt="Logo" class="img-fluid"></a>
                            </div>
                        </div>
                                        ...
                                        <div class="dropdown-menu">
                                            <div class="shopping-cart-content">
                                                ...
                                                <div class="shopping-cart-btn">
                                                    <a class="default-btn" href="../main/cart.html.twig">view cart</a>
                                                    <a class="default-btn" href="../main/checkout.html.twig">checkout</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <ul>
                                                   ...
                                                   <li><a href="../security/login.html.twig">Login</a></li>
                                                   <li><a href="../main/my-account.html.twig">My Account</a></li>
                                                   <li><a href="../main/wishlist.html.twig">Wishlist</a></li>
                                                   <li><a href="../main/checkout.html.twig">Checkout</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
            ...
            <div class="main-nav-area bgc-white">
                <div class="container">
                    <nav id="main_nav" class="stellarnav">
                        <ul>
                            <li><a href="../main/index.html.twig"><span>Home</span></a>
                                <ul>
                                    <li><a href="../main/index.html.twig">Home Page 1</a></li>
                            ...
                            <li class="mega" data-columns="4"><a href="../main/shop-grid.html.twig"><span>Shop</span></a>
                                <ul class="mega-container">
                                    <li><a href="#" class="mega-menu-title"><h3>Shop pages 01</h3></a>
                                        <ul>
                                            <li><a href="../main/shop-grid.html.twig">Shop Grid</a></li>
                                    ...
                                    <li><a href="#" class="mega-menu-title"><h3>Shop pages 02</h3></a>
                                        <ul>
                                            ...
                                            <li><a href="../main/single-product.html.twig">Single Product Page</a></li>
                                            <li><a href="compare.html">Product Compare</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#" class="mega-menu-title"><h3>Shop pages 03</h3></a>
                                        <ul>
                                            <li><a href="../main/cart.html.twig">Cart Page</a><li>
                                            <li><a href="../main/checkout.html.twig">Checkout Page</a></li>
                                            <li><a href="../main/wishlist.html.twig">Wishlist Page</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li><a href="../main/faqs.html.twig"><span>Utility Pages</span></a>
                                <ul>
                                    <li><a href="../main/faqs.html.twig">FAQs Page</a></li>
                                    <li><a href="404.html">404 Page</a></li>
                                </ul>
                            </li>
                            <li><a href="../main/about.html.twig"><span>About Us</span></a></li>
                            <li><a href="../main/contact.html.twig"><span>Contact Us</span></a></li>
                        </ul>
                    </nav>
                </div> <!-- end of container -->
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12">
                        <nav class="breadcrumb">
                            <a class="breadcrumb-item" href="../main/index.html.twig">Home</a>
                            <?php 
                                ...
                                <section class="feedback-wrapper">
                                    ...
                                    <div class="feedback-socials mt-full">
                                        ...
                                        <div class="social-sharing d-flex align-items-center justify-content-center">
                                            <ul class="list-inline">
                                                <li class="list-inline-item"><a href="#" class="bg-facebook" data-bs-toggle="tooltip" data-position="top" data-original-title="Facebook" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                                <li class="list-inline-item"><a href="#" class="bg-twitter" data-bs-toggle="tooltip" data-position="top" data-original-title="Twitter" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                                <li class="list-inline-item"><a href="#" class="bg-gplus" data-bs-toggle="tooltip" data-position="top" data-original-title="Google Plus" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                                <li class="list-inline-item"><a href="#" class="bg-pinterest" data-bs-toggle="tooltip" data-position="top" data-original-title="Pinterest" target="_blank"><i class="fa fa-pinterest"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
